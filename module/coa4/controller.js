...
class Controller {
    ...
    static async list(req, res) {
        try {
            let data = await sq.query(`select c.id as "coa4_id", * from coa4 c join coa3 c2 on c2.id = c.coa3_id where c."deletedAt" isnull and c2."deletedAt" isnull order by c."createdAt" desc `, s);
