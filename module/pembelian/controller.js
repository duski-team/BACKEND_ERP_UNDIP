...
class Controller {
    ...
    static async register(req, res) {
        ...
        try {
            ...
            let hasil = await pembelian.create({ id:pembelian_id , jumlah_pembelian, tanggal_pembelian, persediaan_id, jenis_asset_pembelian_id, vendor_id, company_id,status_pembelian,coa6_id },{transaction:t});
    ...
    static async update(req, res) {
        let { id, jumlah_pembelian, tanggal_pembelian, persediaan_id, jenis_asset_pembelian_id, vendor_id,harga_satuan_txp,harga_total_txp, company_id,coa6_id,master_satuan_id } = req.body
