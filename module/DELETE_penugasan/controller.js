...
//         try {
//             let data = await sq.query(`SELECT p.id as penugasan_id, p.*, s.* FROM penugasan p join sdm s on s.id = p.sdm_id WHERE p."deletedAt" isnull and s."deletedAt" isnull ORDER BY p."createdAt" DESC`, s);
...
//         try {
//             let data = await sq.query(`SELECT p.id as penugasan_id, p.*, s.* FROM penugasan p join sdm s on s.id = p.sdm_id WHERE p."deletedAt" isnull and s."deletedAt" isnull and p.id = '${id}'`, s);
